...
function SignIn() {
  ...
  return (
<div className="flex fixed left-1/2 transform -translate-x-1/2 items-center justify-center min-h-screen mb-10 bg-white px-4">
  <div className="w-full max-w-sm sm:max-w-md md:max-w-lg border p-6 rounded-2xl shadow-md">
    <img className="text-4xl font-serif text-center mb-4 text-black" src={logo} alt="logo" />
